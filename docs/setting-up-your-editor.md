...
Create React SSR App comes with a bunch of tools that improve the editing experience - if configured correctly. Here's a few tips to maximize your productivity:
...
Note that even if you edit your `.eslintrc.json` file further, these changes will **only affect the editor integration**. They won’t affect the terminal and in-browser lint output. This is because Create React SSR App intentionally provides a minimal set of rules that find common mistakes.
...
Visual Studio Code and WebStorm support debugging out of the box with Create React SSR App. This enables you as a developer to write and debug your React code without leaving the editor, and most importantly it enables you to have a continuous development workflow, where context switching is minimal, as you don’t have to switch between tools.
