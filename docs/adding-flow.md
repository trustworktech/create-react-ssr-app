...
Recent versions of [Flow](https://flow.org/) work with Create React SSR App projects out of the box.
...
In the future we plan to integrate it into Create React SSR App even more closely.
