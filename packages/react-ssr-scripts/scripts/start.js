...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    // Create a webpack compiler for the client that is configured with custom messages.
    ...
    // Create a webpack compiler for the server
    const serverCompiler = createServerCompiler(webpack, serverConfig);
    ...
    const wdsConfig = createDevServerConfig(devUrls.lanUrlForConfig);
    const devServer = new WebpackDevServer(clientCompiler, wdsConfig);
