...
function tryGitInit(appPath) {
  ...
  try {
    ...
    execSync('git commit -m "Initial commit from React Starter"', {
      stdio: 'ignore',
    });
    return true;
  } catch (e) {
...
module.exports = function(
  ...
  appPackage.scripts = {
    start: 'react-scripts-iso start',
    build: 'react-scripts-iso build',
    test: 'react-scripts-iso test',
    eject: 'react-scripts-iso eject',
    lint: 'react-scripts-iso lint',
  };
  ...
  args.push('escape-string-regexp', 'express', 'react', 'react-dom');
  if (useTypeScript) {
    args.push(
      '@types/node',
      '@types/express',
