...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// create-react-ssr-app is installed globally on people's computers. This means
// that it is extremely difficult to have them upgrade the version and
// because there's only one global version installed, it is very prone to
// breaking changes.
//
// The only job of create-react-ssr-app is to init the repository and then
// forward all the commands to the local version of create-react-ssr-app.
//
// If you need to add a new command, please add it to the scripts/ folder.
//
// The only reason to modify this file is to add more warnings and
// troubleshooting information for the `create-react-ssr-app` command.
//
// Do not make breaking changes! We absolutely don't want to have to
// tell people to update their global version of create-react-ssr-app.
//
...
const program = new commander.Command(packageJson.name)
  ...
  .option(
    ...
    'use a non-standard version of react-ssr-scripts'
  )
  .option('--use-npm')
  .option('--use-pnp')
  .option('--typescript')
  ...
  .on('--help', () => {
    ...
    console.log(
      `      - a custom fork published on npm: ${chalk.green(
        'my-react-ssr-scripts'
      )}`
    );
    console.log(
      `      - a local path relative to the current working directory: ${chalk.green(
        'file:../my-react-ssr-scripts'
      )}`
    );
    console.log(
      `      - a .tgz archive: ${chalk.green(
        'https://mysite.com/my-react-ssr-scripts-0.8.2.tgz'
      )}`
    );
    console.log(
      `      - a .tar.gz archive: ${chalk.green(
        'https://mysite.com/my-react-ssr-scripts-0.8.2.tar.gz'
      )}`
    );
    console.log(
...
function getInstallPackage(version, originalDirectory) {
  let packageToInstall = 'react-ssr-scripts';
    ...
    console.error(
      chalk.red(
        'You are running Node %s.\n' +
          'Create React SSR App requires Node %s or higher. \n' +
