...
// @remove-on-eject-begin
const getCacheIdentifier = require('@verumtech/react-dev-utils/getCacheIdentifier');
// @remove-on-eject-end
...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    entry: [
      ...
      // to bring better experience for React Starter users. You can replace
          ...
          use: [
            {
              options: {
                ...
                formatter: require.resolve(
                  '@verumtech/react-dev-utils/eslintFormatter'
                ),
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              options: {
                customize: require.resolve(
                  '@verumtech/babel-preset-react-app-spa/webpack-overrides'
                ),
                // @remove-on-eject-begin
                babelrc: false,
                configFile: false,
                presets: [
                  require.resolve('@verumtech/babel-preset-react-app-spa'),
                ],
                // Make sure we have a unique cache identifier, erring on the
                // side of caution.
                // We remove this when the user ejects because the default
                // is sane and uses Babel options. Instead of options, we use
                // the react-scripts-spa and babel-preset-react-app-spa versions.
